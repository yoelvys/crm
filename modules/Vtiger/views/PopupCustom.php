...
class Vtiger_PopupCustom_View extends Vtiger_Footer_View {
	...
	function process (Vtiger_Request $request) {
		...
		$viewer->view('PopupCustom.tpl', $moduleName);
	}
	...
	public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer) {
		...
		$viewer->assign('LISTVIEW_HEADERS', $this->listViewHeaders);
                ...
                $accountCountable = $client->getPACAccountCountableAll();
                $viewer->assign('LISTVIEW_ENTRIES', $accountCountable);
                $viewer->assign('LISTVIEW_ENTIRES_COUNT',count($accountCountable));
