...
jQuery.Class("Vtiger_Edit_Js",{
    ...
    getPopUpParams : function(container) {
       ...
       /* console.log(popupReferenceModule);*/
	...
	openPopUp : function(e){
        ...
        openPopUpCustom : function(e){
            ...
            popupInstance.showCustom(params,function(data){
                var responseData = JSON.parse(data);
                var dataList = new Array();
                for(var id in responseData){
                        var data = {
	...
	referenceModulePopupRegisterEvent : function(container){
        ...
        referenceModulePopupCustomRegisterEvent : function(container){
		var thisInstance = this;
		container.find('.relatedPopupCustom').on("click",function(e){
                    thisInstance.openPopUpCustom(e);
		});
	},
	...
	registerBasicEvents : function(container) {
		this.referenceModulePopupRegisterEvent(container);
                this.referenceModulePopupCustomRegisterEvent(container);
