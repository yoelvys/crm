...
{strip}
	<div class="recordDetails">
               <table class="summary-table">
                    ...
                    {/foreach}    
                    {foreach item=FIELD_MODEL key=FIELD_NAME from=$SUMMARY_RECORD_STRUCTURE['SUMMARY_FIELDS']}
                            {if $FIELD_MODEL->get('name') neq 'modifiedtime' && $FIELD_MODEL->get('name') neq 'createdtime' && (($FIELD_VALUE eq 'Natural' && ($FIELD_NAME neq 'pac_razon_social' )) || ($FIELD_VALUE neq 'Natural' && ($FIELD_NAME neq 'firstname' && $FIELD_NAME neq 'lastname')) )}
