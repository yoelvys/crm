...
$field45->label = 'Razón Social';
$field45->name = 'pac_razon_social';
$field45->table = 'vtiger_contactdetails';
$field45->column = 'pac_razon_social';
$field45->columntype = 'VARCHAR(50)';
$field45->uitype = 1;
$field45->presence = 2;
$field45->typeofdata = 'V~M';
$block->addField($field45);

$field65 = new Vtiger_Field();
$field65->label = 'Nombre Comercial';
$field65->name = 'pac_nombre_comercial';
$field65->table = 'vtiger_contactdetails';
...
$field7->table = 'vtiger_contactdetails';
...
$field8->table = 'vtiger_contactdetails';
...
$field9->label = 'Número de Hijos';
$field9->name = 'pac_numero_hijos';
$field9->table = 'vtiger_contactdetails';
$field9->column = 'pac_numero_hijos';
$field9->columntype = 'INT(2)';
$field9->uitype = 1;
$field9->presence = 2;
...
$blockAddress = Vtiger_Block::getInstance('LBL_ADDRESS_INFORMATION',$module);
$field11 = new Vtiger_Field();
$field11->label = 'Dirección de Gestión';
$field11->name = 'pac_direccion_gestion';
$field11->table = 'vtiger_contactdetails';
$field11->column = 'pac_direccion_gestion';
$field11->columntype = 'TEXT';
$field11->uitype = 21;
$field11->presence = 2;
$field11->typeofdata = 'V~O';
$blockAddress->addField($field11);

$field12 = new Vtiger_Field();
$field12->label = 'Fecha de Ingreso';
$field12->name = 'pac_fecha_ingreso';
$field12->table = 'vtiger_contactdetails';
...
$field18->label = 'Sitio web';
$field18->name = 'pac_sitio_web';
$field18->table = 'vtiger_contactdetails';
$field18->column = 'pac_sitio_web';
...
$field21->table = 'vtiger_contactdetails';
...
$field22->table = 'vtiger_contactdetails';
...
$field23->table = 'vtiger_contactdetails';
...
$field24->table = 'vtiger_contactdetails';
...
$field25->table = 'vtiger_contactdetails';
...
$field26->table = 'vtiger_contactdetails';
...
$field27->table = 'vtiger_contactdetails';
...
$field28->table = 'vtiger_contactdetails';
...
$field29->table = 'vtiger_contactdetails';
...
$field30->table = 'vtiger_contactdetails';
...
$field31->table = 'vtiger_contactdetails';
...
$field32->table = 'vtiger_contactdetails';
...
$field33->table = 'vtiger_contactdetails';
...
$field34->table = 'vtiger_contactdetails';
...
$field35->table = 'vtiger_contactdetails';
...
$field36->table = 'vtiger_contactdetails';
...
$field37->table = 'vtiger_contactdetails';
...
$field38->table = 'vtiger_contactdetails';
...
$field39->table = 'vtiger_contactdetails';
...
$field40->table = 'vtiger_contactdetails';
...
$field41->table = 'vtiger_contactdetails';
...
$field42->table = 'vtiger_contactdetails';
...
$field43->table = 'vtiger_contactdetails';
...
$field46->table = 'vtiger_contactdetails';
...
$field48->table = 'vtiger_contactdetails';
...
$field49->table = 'vtiger_contactdetails';
...
$field50->table = 'vtiger_contactdetails';
...
$field51->table = 'vtiger_contactdetails';
...
$field52->table = 'vtiger_contactdetails';
...
$field53->table = 'vtiger_contactdetails';
...
/*--- DATOS DE GARANTIAS  ------*/
$blockWarrantyData = new Vtiger_Block();
$blockWarrantyData->label = 'LBL_WARRANTY_DATA';
$module->addBlock($blockWarrantyData);

$field55 = new Vtiger_Field();
$field55->label = 'Pagaré';
$field55->name = 'pac_pagare';
$field55->table = 'vtiger_contactdetails';
$field55->column = 'pac_pagare';
$field55->columntype = 'VARCHAR(3)';
$field55->uitype = 56;
$field55->presence = 0;
$field55->typeofdata = 'V~O';
$blockWarrantyData->addField($field55);

$field56 = new Vtiger_Field();
$field56->label = 'Valor Pagaré';
$field56->name = 'pac_valor_pagare';
$field56->table = 'vtiger_contactdetails';
$field56->column = 'pac_valor_pagare';
$field56->columntype = 'DOUBLE(18,2)';
$field56->defaultvalue = 0;
$field56->uitype = 1;
$field56->presence = 2;
$field56->typeofdata = 'V~O';
$blockWarrantyData->addField($field56);

$field57 = new Vtiger_Field();
$field57->label = 'Garante';
$field57->name = 'pac_garante';
$field57->table = 'vtiger_contactdetails';
$field57->column = 'pac_garante';
$field57->columntype = 'VARCHAR(3)';
$field57->uitype = 56;
$field57->presence = 0;
$field57->typeofdata = 'V~O';
$blockWarrantyData->addField($field57);

$field58 = new Vtiger_Field();
$field58->label = 'Fecha de vencimiento';
$field58->name = 'pac_fecha_vencimiento';
$field58->table = 'vtiger_contactdetails';
$field58->column = 'pac_fecha_vencimiento';
$field58->columntype = 'DATE';
$field58->uitype = 5;
$field58->presence = 2;
$field58->typeofdata = 'D~O';
$blockWarrantyData->addField($field58);

/*--- FIN DATOS DE GARANTIAS  ------*/
