...
'><option value="Natural">Natural</option><option value="Jurídica">Jurídica</option></select><?php }else{ ?><span name ="pac_tipo_persona"><?php echo $_smarty_tpl->tpl_vars['FIELD_VALUE']->value;?>
</span><?php }?><?php }} ?>